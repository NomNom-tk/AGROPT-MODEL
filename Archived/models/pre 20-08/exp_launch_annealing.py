...
MODEL_FILE    = "/home/stolte/GAMA_work/experiments/batch_exp_annealing.gaml"
LOG_FILE      = "gama_run_log.txt"
MAX_PARALLEL  = 10   # ← set to 3 if server feels sluggish, 6 if 8 cores available

experiments = [
    "Bt_anneal_no_change",
    "Bt_anneal_cons_ndist",
    "Bt_anneal_cons_dist",
    "Bt_anneal_cons_ndist_speak",
    "Bt_anneal_cons_dist_speak",
    "Bt_anneal_clst_ndist",
    "Bt_anneal_clst_dist",
    "Bt_anneal_clst_ndist_speak",
    "Bt_anneal_clst_dist_speak",
    "Bt_anneal_bipol_ndist",
    "Bt_anneal_bipol_dist",
    "Bt_anneal_bipol_ndist_speak",
    "Bt_anneal_bipol_dist_speak",
]
# ────────────────────────────────────────────────────────────────────────────
