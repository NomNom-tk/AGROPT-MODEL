...
include "actions/data_loader (copy).gaml"; // reads csv, parsers and fill raw data lists (declared in global)
...
global {
    ...
    init {
    	data_loader.load_csv_data(".data/data_complete_anonymised.csv");
